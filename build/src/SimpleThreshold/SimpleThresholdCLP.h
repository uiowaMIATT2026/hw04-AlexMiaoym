...
//  /Users/alex/mym/ece5490/SEM-build/GenerateCLP/bin/GenerateCLP --InputXML /Users/alex/mym/ece5490/hw04-AlexMiaoym/src/SimpleThreshold/SimpleThreshold.xml --OutputCxx /Users/alex/mym/ece5490/hw04-AlexMiaoym/build/src/SimpleThreshold/SimpleThresholdCLP.h
//
#include <cstdio>
#include <cstdlib>
#include <iostream>
...
"<executable>\n"
"    <category>MIATT.HW04.yuamiao</category>\n"
"    <title>Simple Threshold</title>\n"
"    <description>\n"
...
"    <license></license>\n"
"    <contributor>Yuanmin Miao</contributor>\n"
"\n"
"    <parameters>\n"
...
"            <description>Lower threshold for thresholding </description>\n"
...
"            <description>Upper threshold for thresholding </description>\n"
...
"            <description>Value for outside pixels </description>\n"
...
"            <description>Value for inside pixels </description>\n"
...
#define GENERATE_TCLAP_PARSE \
    ...
    fullDescription += "\n        This program is used to threshold an image.\n"; \
    if (!std::string("Yuanmin Miao").empty()) \
      { \
      fullDescription += "\nAuthor(s): Yuanmin Miao"; \
      } \
 ...
 \
    ...
    msg.str("");msg << "Lower threshold for thresholding (value: " << lowThreshold << ")"; \
    TCLAP::ValueArg<int > lowThresholdArg("", "lowThreshold", msg.str(), false, lowThreshold, "int", commandLine); \
 \
    msg.str("");msg << "Upper threshold for thresholding (value: " << highThreshold << ")"; \
    TCLAP::ValueArg<int > highThresholdArg("", "highThreshold", msg.str(), false, highThreshold, "int", commandLine); \
 \
    msg.str("");msg << "Value for outside pixels (value: " << outsideValue << ")"; \
    TCLAP::ValueArg<int > outsideValueArg("", "outsideValue", msg.str(), false, outsideValue, "int", commandLine); \
 \
    msg.str("");msg << "Value for inside pixels (value: " << insideValue << ")"; \
    TCLAP::ValueArg<int > insideValueArg("", "insideValue", msg.str(), false, insideValue, "int", commandLine); \
 \
    msg.str("");msg << "Input volume to be filtered";    TCLAP::ValueArg<std::string > inputArg("", "inputVolume", msg.str(), false, input, "std::string", commandLine); \
 \
    msg.str("");msg << "Output filtered";    TCLAP::ValueArg<std::string > outputArg("", "outputVolume", msg.str(), false, output, "std::string", commandLine); \
 \
